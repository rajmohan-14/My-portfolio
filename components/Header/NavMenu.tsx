  ...
  return (
    <>
      ...
      <span className='flex items-center gap-3'>
        <DarkMode />
        <Link href='/Raj-Mohan-Resume.pdf' target='_blank' className='rounded-lg bg-primaryColor px-3 py-1 text-headingDarkText inline-flex gap-2 items-center relative'>
          Resume
